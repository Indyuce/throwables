...
public class ConfigFile {
    ...
    public ConfigFile(String folder, String name) {
        this(Throwables.plugin, folder, name);
    }
    ...
    public void save() {
        try {
            ...
            Throwables.plugin.getLogger().log(Level.SEVERE, "Could not save " + file.getName() + ".yml: " + exception.getMessage());
        }
    }
}